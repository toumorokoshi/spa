...
- **Mermaid Editor**: Future enhancements could include pan/zoom controls for large diagrams, custom CSS/theme variable styling, direct `.svg` / `.png` file download buttons, and persisting diagram drafts to `localStorage`.
