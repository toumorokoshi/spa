...
- **Mermaid Editor**: Future enhancements could include pan/zoom controls for large diagrams, theme toggling (dark/forest/neutral), direct `.svg` / `.png` file download buttons, and persisting diagram drafts to `localStorage`.
